...
let ChatController = class ChatController {
    ...
    async send(body) {
        return await this.chatService.send(body.messages);
    }
};
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Send messages to Groq AI' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'AI response returned' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [send_messages_dto_1.SendMessagesDto]),
    __metadata("design:returntype", Promise)
